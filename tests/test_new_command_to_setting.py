...
from tex_tool.ltex.new_command_to_setting import build_setting, convert_new_commands


def test_build_setting_ignores_empty_lines() -> None:
    lines = ["\\newcommand{\\foo}{}", "", "   ", "\\newcommand{\\bar}{}"]
...
def test_convert_new_commands_writes_json(tmp_path: Path) -> None:
